...
Optional for SaaS-style deployments: set `GIT_SERVICE_URL` (for example `http://git-service:8080`) to delegate external git clone and remote tag operations to git-service.

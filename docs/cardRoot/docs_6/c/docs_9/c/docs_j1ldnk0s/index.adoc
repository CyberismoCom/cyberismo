...
* {{#xref}}"cardKey":"docs_28"{{/xref}}
* {{#xref}}"cardKey":"docs_chclhxsk"{{/xref}}
* {{#xref}}"cardKey":"docs_33"{{/xref}}
* https://handlebarsjs.com/guide/[Introduction to the Handlebars templating engine]
* {{#xref}}"cardKey":"docs_byr4iof0"{{/xref}}
* {{#xref}}"cardKey":"docs_r0brt7n1"{{/xref}}
...
For example, we can show the child cards of {{#xref}}"cardKey":"docs_17"{{/xref}} with the following report macro:

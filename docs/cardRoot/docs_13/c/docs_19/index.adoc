...
== NPM registry
If you installed Cyberismo from the NPM registry, you can update it to the latest version by reinstalling against the `latest` tag:

  $ npm install -g @cyberismo/cli@latest

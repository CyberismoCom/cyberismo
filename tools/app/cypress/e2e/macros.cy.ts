...
describe('Navigation', () => {
  ...
  it('Create cards macro', () => {
    ...
    // Wait for navigation to the new Page card. Use exact-match so we don't
    // race against the previous card's "Untitled page content" h1, which
    // substring-matches "Untitled page" and would let the next click target
    // the (about-to-unmount) old CardTitle.

    ...
    setupNodeEvents(on, config) {
      on('task', {
        ...
        createTestProject() {
          ...
          execSync(
            'cd ../../.tmp&&cyberismo create project "Basic Acceptance Test" bat cyberismo-bat&&cd cyberismo-bat&&cyberismo import module ../module-base&&cyberismo create card base/templates/page&&cyberismo calc generate',
          );
          return true;
        },
      });

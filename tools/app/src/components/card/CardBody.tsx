...
export const CardBody = forwardRef<CardBodyHandle, CardBodyProps>(
  function CardBody({ card, preview, onContentSave, onEditingChange }, ref) {
    ...
    useEffect(() => {
      ...
      // Watch for wrappers added later (e.g. async mermaid rendering)
    ...
    // The backend emits <div class="mermaid-block" data-mermaid-code="base64"> placeholders.
    useEffect(() => {
      if (!contentRef) return;
    ...
    }, [contentRef, isDarkMode, location.key, card.parsedContent]);

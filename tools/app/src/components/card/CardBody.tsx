...
import { addAttachment } from '@/lib/codemirror';
...
export const CardBody = forwardRef<CardBodyHandle, CardBodyProps>(function CardBody(
  { card, preview, onContentSave, onEditingChange },
  ref,
) {
      ...
      {editing ? (
        ...
        >
          <Stack spacing={1}>
            ...
            {previewing ? (
              <Box maxHeight="calc(100vh - 250px)" overflow="auto" padding={1}>
                {previewHtml === null ? (

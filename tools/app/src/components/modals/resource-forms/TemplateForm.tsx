...
export function TemplateForm({
  onSubmit,
  isSubmitting,
}: ResourceFormProps<CreateTemplateData>) {
  ...
  const onFormSubmit = async (data: CreateTemplateData) => {
    await onSubmit(data);
  };
      ...
      <Stack spacing={2}>
          ...
          render={({ field }) => (
            <FormControl error={!!errors.identifier}>
              ...
              <Input
                ...
                startDecorator={<ProjectIdentifier type="templates" />}
              />
        ...
        >
          {t('newResourceModal.create', {
            resourceType: t('newResourceModal.templates.name'),
          })}
        </Button>
      </Stack>
    </form>

...
- Create a new directory under `tools/assets/src/schema/migrations/`
...
- Use the Project API to work with resources (cardTypes, workflows, etc.)
- Try to access cardRoot cards indirectly only through resource updates (update())
...
- `project`: Project instance for accessing project functionality

## Working with Project Resources

Migrations can use the Project API to work with resources. The generated template includes helper code to access the Project instance.

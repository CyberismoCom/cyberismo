...
// test/coalesce.test.ts pins NODE_CLINGO_MAX_CONCURRENT=1 to make that deterministic
// instead of racing real hardware concurrency.
//
...
// rest of the suite -- vitest.config.ts excludes this file, and package.json's `test`

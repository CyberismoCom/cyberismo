...
clears presence. Below Editor, `mode: 'editing'` is silently coerced to
`viewing`. Responds 204 either way, 400 if the body fails validation, or 404
for an unknown card or a connection that is unknown or belongs to another
user.

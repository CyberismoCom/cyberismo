...
// jsdom and dompurify are loaded on first use: together they cost ~1s of
// import time, and only the macros that render SVG ever need them. Loading
// them at module scope made every CLI invocation pay for it, help included.

...
/**
 * Converts resource object to Resource.
 * @param object Resource object of any type.
 * @returns Resource information (file name and path)
 */
export function resourceObjectToResource(
  object: FileResource | FolderResource,
): Resource {
  // todo: if folder resource - should use folder as well
  return {

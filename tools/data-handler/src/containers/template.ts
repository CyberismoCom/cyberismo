...
export class Template extends CardContainer {
  ...
  // the destination tree (see instantiatedPaths), which is the same rule the
  // tree itself uses to derive them.
  ...
  // project's cache, so there is nothing to look them up by.

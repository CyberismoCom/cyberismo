...
export class Show {
     ...
     */
    public async showAttachments(projectPath: string): Promise<attachmentDetails[]> {
     ...
     */
    public async showAttachment(projectPath: string, cardKey: string, filename: string): Promise<attachmentPayload> {
        if (!cardKey) {
     ...
     */
    public async showCardDetails(projectPath: string, details: fetchCardDetails, cardKey?: string): Promise<card> {
        if (!cardKey) {
            throw new Error(`Mandatory parameter 'cardKey' missing`);
        }
        Show.project = new Project(projectPath);
     ...
     */
    public async showCardTypeDetails(projectPath: string, cardtypeName: string): Promise<cardtype> {
        Show.project = new Project(projectPath);
        if (cardtypeName === '') {
    ...
    */
    public async showCardTypesWithDetails(projectPath: string): Promise<(cardtype|undefined)[]> {
        Show.project = new Project(projectPath);
     ...
     */
    public async showFieldType(projectPath: string, fieldTypeName: string): Promise<fieldtype | undefined> {
        Show.project = new Project(projectPath);
     ...
     */
    public async showModule(projectPath: string, moduleName: string): Promise<moduleSettings> {
        Show.project = new Project(projectPath);
     ...
     * @returns all modules in a project.
     */
    public async showModulesWithDetails(projectPath: string): Promise<(moduleSettings|undefined)[]> {
        Show.project = new Project(projectPath);
        const promiseContainer = [];
     ...
     */
    public async showTemplate(projectPath: string, templateName: string): Promise<object> {
        Show.project = new Project(projectPath);
     ...
     */
    public async showWorkflow(projectPath: string, workflowName: string): Promise<workflowMetadata> {
        Show.project = new Project(projectPath);
        if (workflowName === '') {
     ...
     */
    public async showWorkflowsWithDetails(projectPath: string): Promise<(workflowMetadata|undefined)[]> {
        const promiseContainer = [];
        Show.project = new Project(projectPath);

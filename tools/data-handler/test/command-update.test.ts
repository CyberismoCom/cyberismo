...
describe('update command', () => {
  ...
  it('update file resource', async () => {
    ...
    const exists = project.resourceExists(name);
  ...
  it('update card type workflow with complete state mapping (success)', async () => {
    ...
    const cardType = project.resourceByType(name, 'cardTypes').data;
  ...
  it('update content - graphview viewTemplate', async () => {
    ...
    const graphView = await project.resourceByType(name, 'graphViews').show();
  ...
  it('update content - graphModel model', async () => {
    ...
    const graphModel = await project.resourceByType(name, 'graphModels').show();
  ...
  it('update content - report contentTemplate', async () => {
    ...
    const report = await project.resourceByType(name, 'reports').show();

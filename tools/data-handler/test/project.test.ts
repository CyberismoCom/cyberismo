...
describe('project', () => {
  ...
  it('create class - paths to resources (success)', async () => {
    ...
    const calculationFolder = project.paths.resourceFolderFor(version, 'calculations');
    const tempCalculationFolder = project.paths.calculationFolder;
    const cardRootFolder = project.paths.cardRootFolder;
    const cardTypesFolder = project.paths.resourceFolderFor(version, 'cardTypes');
    const graphModelsFolder = project.paths.resourceFolderFor(version, 'graphModels');
    const graphViewsFolder = project.paths.resourceFolderFor(version, 'graphViews');
    const templatesFolder = project.paths.resourceFolderFor(version, 'templates');
    const workflowsFolder = project.paths.resourceFolderFor(version, 'workflows');

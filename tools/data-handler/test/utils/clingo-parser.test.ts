...
describe('ClingoParser', () => {
  ...
  it('should parse query_error correctly with 4 params', () => {
    const input =
  ...
  it('should parse query_error correctly with 0 params', () => {
  ...
  it('should parse child_result correctly', () => {
  ...
  it('should parse link without linkDescription correctly', () => {
  ...
  it('should parse transition_denied correctly', () => {
    const input =
  ...
  it('should parse moving_card_denied correctly', () => {
  ...
  it('should parse deleting_card_denied correctly', () => {
    const input =
  ...
  it('should parse editing_field_denied correctly', () => {
    const input =
  ...
  it('should parse editing_content_denied correctly', () => {
    const input =
  ...
  it('should parse policy_check_failure correctly', () => {
    const input =
  ...
  it('should parse policy_check_success correctly', () => {
    const input =
  ...
  it('should handle multiple results correctly when sorting', () => {
    const input = `
            result("key1")
            result("key2")
            field("key1", "field", "b")
  ...
  it('should handle multiple results correctly when sorting in reverse', () => {
    const input = `
            result("key1")
            result("key2")
            field("key1", "field", "b")
  ...
  it('should handle order on multiple levels correctly', () => {
    const input = `
        result("key1")
  ...
  it('should handle order on multiple levels correctly in reverse', () => {
    const input = `
        result("key1")
        child_result("key1", "key2")
        field("key2", "field", "b")
  ...
  it('should handle oreder on 4th level correctly', () => {
    const input = `
        result("key1")
        child_result("key1", "key2")

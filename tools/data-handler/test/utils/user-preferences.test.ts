...
describe('UserPreferences', () => {
    ...
    it('gets edit command preferences', () => {
        ...
        expect(userPrefs.getPreferences().editCommand.darwin.command).to.equal('code');
    });
    ...
    it('reports if the preferences directory is non-writable', () => {
        ...
        const nonWritablePath = platform() === "win32" ? 'U:/this/path/does/not/exist' : '/this/path/does/not/exist';
